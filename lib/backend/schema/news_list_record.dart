...
class NewsListRecord extends FirestoreRecord {
  ...
  // "image_page" field.
  List<String>? _imagePage;
  List<String> get imagePage => _imagePage ?? const [];
  bool hasImagePage() => _imagePage != null;
  ...
  void _initializeFields() {
    ...
    _imagePage = getDataList(snapshotData['image_page']);
...
class NewsListRecordDocumentEquality implements Equality<NewsListRecord> {
  ...
  bool equals(NewsListRecord? e1, NewsListRecord? e2) {
    ...
    return e1?.createDate == e2?.createDate &&
        ...
        e1?.detail == e2?.detail &&
        listEquality.equals(e1?.imagePage, e2?.imagePage) &&
